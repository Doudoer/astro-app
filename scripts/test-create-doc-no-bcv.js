...
(async ()=>{
  try{
    ...
    const payload = {
      ...
      cliente_id: null,
      currency: 'VES',
      exchange_rate: 250.75, // example rate but NOT including bcv_rate
      items: [ { product_id: null, description: 'Producto sin bcv', quantity: 1, unit_price_usd: 20.00, discount: 0 } ]
    };
